...
async def save_group(bot, message):
    ...
    if temp.ME in dreamx_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[InlineKeyboardButton('📌 ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ 📌', url=https://t.me/Anujedits76)]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton("👩‍🌾 Bot Owner 👩‍🌾", url=https://t.me/Anujedits76)
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
                ...
                try:
                    temp.MELCOW['welcome'] = await message.reply_photo(
                        ...
                        reply_markup=InlineKeyboardMarkup([
                                [
                                    InlineKeyboardButton("📌 ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ 📌", url=https://t.me/Anujedits76)
